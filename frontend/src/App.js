      ...
      <Router>
        ...
        <div className="App">
          ...
          <Route 
            path="/login" 
            element={
              user ? <Navigate to="/menu" /> : <Navigate to="/login/customer" />
            } 
          />
          <Route 
            path="/login/:role" 
          ...
          <Route 
            path="/menu" 
            element={
              <ProtectedRoute isAllowed={!!user && (user.role === 'customer' || user.role === 'admin' || user.role === 'staff')} redirectTo="/login/customer">
                <Menu 
                  user={user} 
          ...
          <Route 
            path="/cart" 
            element={
              <ProtectedRoute isAllowed={!!user && user.role === 'customer'} redirectTo="/login/customer">
                <Cart 
                  cart={cart}
          ...
          <Route 
            path="/dashboard" 
            element={
              <ProtectedRoute isAllowed={!!user && (user.role === 'admin' || user.role === 'staff')} redirectTo="/menu">
                <Dashboard />
              </ProtectedRoute>
            } 
          />
